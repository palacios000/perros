<footer>
	...
	<div class="bg-perros-brown">
		<div class="container mx-auto py-16 text-white text-xm font-oswald">
			<img class="w-1/6 pb-4" src="<?php echo $config->urls->templates ?>styles/images/PERROSLIFE_logo-2.svg" alt="Logo Perros Life">
	...
	<div class="bg-neutral-300">
		<div class="container mx-auto">
			<div class="grid grid-cols-2 text-xxs py-4">
				...
				<p class="text-right">Design by the Waseschas</p>
			</div>
		</div>
	</div>
